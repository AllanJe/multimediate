...
```{r}
  mahifit <- mahi2(datahigh,name.exposure="X",name.outcome="Y",name.mediators=paste0("M", 1:p),
                   lambda=lambda,Nboot=30,L0=.1,eta=2,tau=1/P,epsilon=.001,Kmax=NULL,p.adjust.method="hochberg",pvalseuil=0.05)
```

The function mahi2 returns a list containing several results such as the mediators selected in the first step. 

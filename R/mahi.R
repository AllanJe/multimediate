...
mahi=function(data,name.exposure,name.outcome,name.mediators,lambda,Nboot=100,L0=.1,eta=2,tau=1/P,epsilon=.001,Kmax=NULL,bin=FALSE,step2=FALSE,p.adjust.method="bonferroni",pvalseuil=0.05){
  n=dim(data)[1]
